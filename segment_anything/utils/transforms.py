...
from .to_pil_images import ToPILImage
...
class ResizeLongestSide:
    ...
    def apply_image(self, image: np.ndarray) -> np.ndarray:
        ...
        return np.array(resize(ToPILImage()(image), target_size))
    ...
    def apply_image_torch(self, image: paddle.Tensor) -> paddle.Tensor:
        """
    ...
    def apply_coords_torch(
        ...
        coords = deepcopy(coords).astype('float32')
        coords[..., 0] = coords[..., 0] * (new_w / old_w)
        coords[..., 1] = coords[..., 1] * (new_h / old_h)
        return coords
